...
function goHome(event)
	if event.phase == "ended" then
		storyboard.removeScene("createmultiplication")
...
function insertButtons(n)
	...
	--operator
	operatortext = display.newText("x",centerX-130*xscale,centerY-105*yscale,"Comic Relief",40)
...
function submit(n)
	...
	if leftnum * rightnum == answernum then
		...
		continue:addEventListener("tap", multNewSceneListener)
