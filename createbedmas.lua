...
function insertButtons(n)
	...
	--zero
	zerobg = display.newImage("images/button.png",40+50*2*xscale,centerY+100*yscale)
	...
	--division
	divbg = display.newImage("images/button.png",40+50*4*xscale,centerY-50*yscale)
	...
	--multiplication
	multbg = display.newImage("images/button.png",40+50*4*xscale,centerY+50*yscale-50*yscale)
	...
	--addition
	addbg = display.newImage("images/button.png",40+50*4*xscale,centerY+50*yscale)
	...
	--subtraction
	subbg = display.newImage("images/button.png",40+50*4*xscale,centerY+100*yscale)
	...
	--clear
	clearbg = display.newImage("images/button.png",centerX+130*xscale,centerY+60*yscale)
