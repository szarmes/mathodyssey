...
function scene:enterScene( event )
	if questionCount>=10 then
		...
		instructions4 = "In this case, the perimeter is "..sides*length	
...
function perimeterdisplayNumbers(n)
	local screenGroup = n
	question = display.newText("Side length: "..length, centerX+60*xscale, centerY-60*yscale, "Comic Relief", 20)
